                                        ...
                                        <div class="col-sm-12">
                                            <table class="table data-table table-hover mb-0 dataTable no-footer"
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr class="odd">
                                                            <td class="sorting_1"><?php echo $qty; ?></td>
                                                            <td><?php echo $row1["madonhang"]; ?></td>
                                                            <td><b><?php echo $row1["name"]; ?></b></td>
                                                            <td><b style="color:green;"><?php echo $row1["trangthai"]; ?></b></td>
                                                            <td><b style="color:blue;"><?php echo $row1["soluong"]; ?></b></td>
                                                            <td><b style="color:red;"><?php echo number_format($row1["price"] * $row1["soluong"]); ?>đ</b></td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
