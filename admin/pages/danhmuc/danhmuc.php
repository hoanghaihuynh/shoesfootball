...
<!-- partial -->
<div class="main-panel" style="margin: 64px 0 0 280px;">
    <div class="box">
        ...
        <form class="box-body" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" class="form-control" name="title" placeholder="Tên danh mục" value=""
                    required fdprocessedid="i9pziq" onkeyup="ChangeToSlug();">
            </div>
