        ...
        <form class="box-body" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" placeholder="Title"
                    value="<?php echo ''.$row1["title"]?>" id="title" fdprocessedid="oboy0m">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="chitiet" placeholder="Chi tiết"
                    value="<?php echo ''.$row1["detail"]?>" id="chitiet" fdprocessedid="oboy0m">
            </div>
...
$sql = "UPDATE banner SET `image`= '$site_domain/admin/pages/settings/uploads/$image',`title`= '$title',`detail`= '$chitiet' WHERE `id` = '$id'";
    if ($conn->query( $sql)) {
