...
<?php 
                            $i = 1;
                                $query = $conn->query("SELECT * FROM `gioithieu` WHERE `id` = '$id'");
...
<div class="main-panel" style="padding:20px">
    ...
    <div class="box-header with-border">
        <div class="left">
            <h3 class="box-title">Sửa giới thiệu</h3>
        </div>
    </div><!-- /.box-header -->
    ...
    <!--print custom success message-->
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="title" placeholder="Liên kết" value="<?php echo ''.$row1["title"]?>" id="title"  fdprocessedid="oboy0m">
        </div>

        <div class="form-group">
            <label class="control-label">Mô Tả
            </label>
            <input type="text" class="form-control" name="mota" placeholder="Mô Tả" value="<?php echo ''.$row1["content"]?>" id="mota"  fdprocessedid="oboy0m">
        </div>
    ...
    <div class="box-body">
            ...
            <div class="form-group">
                <button type="submit" name="submit" value="1" class="btn btn-primary pull-right" onclick="allow_submit_form = true;" fdprocessedid="bxji3">Lưu</button>
...
$sql = "UPDATE gioithieu SET `title`= '$title',`content`= '$mota' WHERE `id` = '$id'";
    if ($conn->query( $sql)) {
