...
<div class="main-panel" style="padding:20px">
 ...
 <div class="form-group">
            ...
            <input type="text" class="form-control" name="title" placeholder="Tiêu Đề" value="" id="title"  fdprocessedid="oboy0m" onkeyup="ChangeToSlug();">
        </div>
        <div class="form-group">
            <label class="control-label">Liên kết (có thể bỏ trống)
            </label>
            <input type="text" class="form-control" name="link" placeholder="Liên kết" value="" id="link"  fdprocessedid="oboy0m">
        </div>
 <div class="form-group">
            <label class="control-label">Chi Tiết
            </label>
             <textarea name="chitiet" id="chitiet" placeholder="Chi Tiết" style="width:70%;height:200px;">
...
$sql = "UPDATE tintuc SET `title`= '$title',`chitiet`= '$chitiet',`date`= '$date',`image`= '$site_domain/admin/pages/tintuc/image/$image',`lienket`= '$chitiet' WHERE `id` = '$id'";
    if ($conn->query( $sql)) {
        ...
        $sql = "UPDATE tintuc SET `title`= '$title',`chitiet`= '$chitiet',`date`= '$date',`lienket`= '$chitiet' WHERE `id` = '$id'";
    if ($conn->query( $sql)) {
        echo '<script>alert("Bạn Đã Cập Nhật Thành Công!");</script>';
        header('Location: #');
