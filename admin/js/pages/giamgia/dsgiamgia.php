        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="text-right">
                    <a href="/admin/pages/giamgia/giamgia.php" >THÊM GIẢM GIÁ</a>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="table-responsive">
                    <table id="datatable1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php 
                            $i = 1;
                                $query = $conn->query("SELECT * FROM `giamgia`");
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href='editGiamGia.php?updateid=<?php echo ''.$row1["id"]?>' class="btn btn-default">Sửa</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
