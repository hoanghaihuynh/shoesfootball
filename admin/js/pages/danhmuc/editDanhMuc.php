...
<div class="main-panel" style="padding-left:50px;padding-top:20px;padding-right:50px">
    ...
    <!--print custom success message-->
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="title" placeholder="Liên kết" value="<?php echo ''.$row1["danhmucchinh"]?>" id="title"  fdprocessedid="oboy0m" >
        </div>
<div class="form-group">
            <label class="control-label">Tên danh mục
            </label>
            <input type="text" class="form-control" name="name" placeholder="Liên kết" value="<?php echo ''.$row1["tendanhmuc"]?>" id="name"  fdprocessedid="oboy0m" onkeyup="ChangeToSlug();">
        </div>
        <div class="form-group">
