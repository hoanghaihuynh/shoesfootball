...
<div class="main-panel" style="padding-left:50px;padding-top:20px;padding-right:50px">
    ...
    <div class="box-header with-border">
        <div class="left">
            <h3 class="box-title">Đăng danh mục</h3>
        </div>
    </div><!-- /.box-header -->
    ...
    <!--print custom success message-->
        ...
        <div class="form-group">
            ...
            <input type="text" id="title" class="form-control" name="title" placeholder="Tên danh mục" value="" required fdprocessedid="i9pziq" onkeyup="ChangeToSlug();">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="danhmucc" class="form-control" name="danhmucc" placeholder="Danh mục chính" value="san-pham" required fdprocessedid="i9pziq" >
        </div>
