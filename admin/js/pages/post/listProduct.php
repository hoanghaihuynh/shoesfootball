        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="text-right">
                    <a href="/admin/pages/post/addProduct.php" >THÊM SẢN PHẨM</a>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            $i = 0 ;
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href='delete.php?xoasp=<?php echo ''.$row1["id"]?>' class="btn btn-default">Xoá</a>
                                    </td>
                                    <td class="text-center">
                                        <a href='editProducts.php?updateid=<?php echo ''.$row1["id"]?>' class="btn btn-default">Sửa</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
