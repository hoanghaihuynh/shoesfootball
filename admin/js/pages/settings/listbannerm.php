        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="text-right">
                    <a href="/admin/pages/settings/addbanner.php" >THÊM BANNER</a>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            $i = 1;
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href='delete1.php?huydeleidt=<?php echo ''.$row1["id"]?>' class="btn btn-default">Xoá</a>
                                    </td>
                                    <td class="text-center">
                                        <a href='editBanner.php?updateid=<?php echo ''.$row1["id"]?>' class="btn btn-default">Sửa</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
