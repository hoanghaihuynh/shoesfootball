        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="text-right">
                    <a href="/admin/pages/settings/addGiamGiaAds.php" >THÊM BANNER</a>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="table-responsive">
                    <table id="datatable1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php 
                            $i = 1;
                                $query = $conn->query("SELECT * FROM `bannerads`");
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href='editBannerAds.php?updateid=<?php echo ''.$row1["id"]?>' class="btn btn-default">Sửa</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
