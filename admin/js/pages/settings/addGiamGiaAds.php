...
<div class="main-panel" style="padding-left:50px;padding-top:20px;padding-right:50px">
    ...
    <div class="box-header with-border">
        <div class="left">
            <h3 class="box-title">Đăng banner Ads</h3>
        </div>
    </div><!-- /.box-header -->
...
$sql = "INSERT IGNORE INTO bannerads (image,lienket,trangthai) VALUES ('https://orgamicheart.com/admin/pages/settings/uploads/$image','$lienket','$select')";
    if ($conn->query( $sql)) {
